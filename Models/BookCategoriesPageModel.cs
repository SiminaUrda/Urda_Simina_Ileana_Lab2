...
namespace Urda_Simina_Ileana_Lab2.Models;

public class BookCategoriesPageModel : PageModel
{
    public List<AssignedCategoryData> AssignedCategoryDataList;
    public void PopulateAssignedCategoryData(Urda_Simina_Ileana_Lab2Context context,
    Book book)
    {
    ...
    public void UpdateBookCategories(Urda_Simina_Ileana_Lab2Context context,
